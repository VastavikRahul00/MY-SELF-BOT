...
DATABASE_NAME = environ.get('DATABASE_NAME', "SHANKS")
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Moviee_filterr_bot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'Moviee_filterr_bot'))
